...
function ContextSidebar({ sources, highlights }) {
  return (
    <aside className="w-[30%] bg-white border-r border-gray-200 p-6 h-[calc(100vh-73px)] sticky top-[73px] overflow-y-auto">
