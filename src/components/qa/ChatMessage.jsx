function ChatMessage({ type, content, children }) {
  if (type === 'user') {
    return (
      <div className="flex justify-end">
        <div className="bg-blue-600 text-white p-4 rounded-xl rounded-br-none max-w-2xl shadow-md">
  ...
  return (
    <div className="flex justify-start items-start gap-4">
      ...
      <div className="bg-white p-6 rounded-xl rounded-bl-none shadow-sm border border-gray-200 max-w-4xl">
        {children}
      </div>
    </div>
  )
